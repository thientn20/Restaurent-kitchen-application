...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        subtitle= new JLabel("LeCorto Restaurant");
        subtitle.setFont(new Font("sansserif",1,28));
        subtitle.setForeground(new Color(245,245,245));
        add(subtitle);
        
        description = new JLabel("Để sử dụng dịch vụ tại đây,");
        description.setForeground(new Color(245,245,245));
        add(description);
        
        description1 = new JLabel("vui lòng đăng nhập với tài khoản cá nhân của bạn");
