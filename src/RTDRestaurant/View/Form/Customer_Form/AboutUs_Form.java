...
public class AboutUs_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        wel.setText("<html>  Chào mừng đến với<i style=\"color:rgb(108,91,123);font-size:16px;\">  LeCorto Restaurant<i> </html>");
        ...
        footer.setText("Since : 2024 - Thành lập bởi đội ngũ LeCorto");
        ...
        listMember.setText("Thành viên đội ngũ:\n\tTrần Ngọc Thiện - Developer\n\tNguyễn Minh Mẫn -  Developer");
        ...
        header1.setText("Cảm nhận vị thiên đường trên đầu lưỡi. ");
