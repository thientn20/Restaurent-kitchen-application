...
public class InsertAndUpdate_Staff_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        if (data == null) {
            ...
            if(data.getTinhTrang().equals("Đang làm việc")){
            cmdKick.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    if (data.getChucvu().equals("Quản lý")) {
            ...
            }else if(data.getTinhTrang().equals("Đã nghỉ việc")) {
    ...
    private void initComponents() {
        ...
        lbNVL.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lbNVL.setText("Ngày vào làm:");
        ...
        cbboxCvu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nhân viên phục vụ", "Lễ tân", "Thu ngân", "Nhân viên bếp", "Nhân viên Kho", "Quản lý" }));
        ...
        lbmaNQL.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
