...
public class InsertAndUpdate_Food_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        if (data == null) {
            ...
            if (data.getState().equals("Đang kinh doanh")) {
            ...
            } else if (data.getState().equals("Ngưng kinh doanh")) {
    ...
    private void initComponents() {
        ...
        lbmaMA.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        lbtenMA.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        lbloai.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
